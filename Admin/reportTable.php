                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title">Report Table List</h4>
                                </div>
                                <div class="card-body table-full-width table-responsive">
                                    <form action="reportTable.php" method="POST">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="../report/<?php echo $report_file ?>" target="_blank" download><?php echo $report_file ?></a></td>
                                                            <td><?php echo $created_time ?></td>

                                                            <td class="text-center">
                                                                <button name="delete" type="submit" class="btn btn-danger" value="<?php echo $appointment_id ?>" onclick="return confirm('Are you sure you want to delete?')">Delete</button>
                                                            </td>
                                                        </tr>
                                                <?php
                                                    } //end while
